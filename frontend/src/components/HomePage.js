    ...
    <section
        ...
        <div class="px-3 w-full lg:w-2/5">
            ...
            <div class="text-center lg:text-left">
                ...
                <a class="block visible py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-slate-500">How We Work?</a>
            </div>
        </div>
